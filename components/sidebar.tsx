...
export function Sidebar() {
  ...
  return (
    <>
      {/* Sidebar */}
      <div className={cn(
        "fixed left-0 top-0 z-50 h-full bg-gradient-to-b from-gray-900/95 to-gray-800/95 backdrop-blur-xl border-r border-gray-800/50 shadow-2xl shadow-gray-900/50 transition-all duration-300 hidden md:block",
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-800/50 space-y-2">
            ...
            <Button
              ...
              size="sm"
              className={cn(
                "w-full justify-start text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-xl transition-all duration-300",
            ...
            >
              ...
              {!isCollapsed && <span className="ml-3">Aide</span>}
            </Button>
            ...
            >
              ...
              {!isCollapsed && <span className="ml-3">Son</span>}
            </Button>
